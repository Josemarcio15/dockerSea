<script lang="ts">
  ...
  import { DangerButton, PrimaryButton } from "$lib/components/buttons";
...
>
  ...
  <div class="flex items-center justify-between gap-3">
    ...
    <div class="flex items-center gap-2 shrink-0">
      <span
        class="px-2.5 py-1.5 rounded-xl text-xs font-bold border {driverBadgeClass}"
      >
        {network.driver}
      </span>
      <span
  ...
  {#if expanded}
    <div class="flex flex-col gap-3 text-xs pt-1">
      ...
      >
        ...
        {:else}
          <div
            class="py-2 text-left italic text-slate-400 dark:text-slate-500 text-xs"
          >
